...
- (void)setupSlideBar {
    ...
    slide.itemSelectedColor = [UIColor blueColor];
    slide.sliderColor = [UIColor blueColor];
...
- (FDSlideBar *)slideBar {
    if (_slideBar == nil) {
        _slideBar = [[FDSlideBar alloc] initWithFrame:CGRectMake(0, TopHeight, self.view.frame.size.width, kDefaultHeightOFSlideBar)];
