...
#import "ODSpringView.h"
#import "ODVertexAttribArrayBuffer.h"
#import "ODShaderHelper.h"
...
@interface ODSpringView () <GLKViewDelegate>

@property (nonatomic, strong) GLKBaseEffect *baseEffect;
@property (nonatomic, assign) SenceVertex *vertices;

@property (nonatomic, strong) ODVertexAttribArrayBuffer *vertexAttribArrayBuffer;
...
- (void)commonInit {
    ...
    self.vertexAttribArrayBuffer = [[ODVertexAttribArrayBuffer alloc] initWithAttribStride:sizeof(SenceVertex) numberOfVertices:kVerticesCount data:self.vertices usage:GL_STATIC_DRAW];
}
...
- (void)resetTextureWithOriginWidth:(CGFloat)originWidth
    ...
    // 获取着色器程序
    GLuint program = [ODShaderHelper programWithShaderName:@"spring"];
    ...
    ODVertexAttribArrayBuffer *vbo = [[ODVertexAttribArrayBuffer alloc] initWithAttribStride:sizeof(SenceVertex) numberOfVertices:kVerticesCount data:tmpVertices usage:GL_STATIC_DRAW];
